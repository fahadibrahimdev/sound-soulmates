...
<template>
  <section id="faqs" class="faqs-section flex items-center relative h-[600px] sm:h-[840px] md:h-[900px] lg:h-[1100px] 2xl:h-[1500px] 3xl:h-[1700px]">
    <div class="container text-center">
        <div>
          <h3 class="text-primary text-3xl lg:text-4xl xl:text-5xl 3xl:text-5.5xl w-3/4 xl:w-2/4 md:w-full mx-auto font-bold pb-5">
            {{ faqsContent.heading }}
          </h3>
      ...
      <div class="faqs-wrapper flex flex-col gap-4 pd-5 md:px-10 xl:px-20 pt-20 2xl:pt-26">
        ...
        >
          <div @click="toggleItem(index)" class="cursor-pointer text-base md:text-lg xl:text-2xl">
            <div class="flex justify-between items-center gap-5 font-bold text-black">
